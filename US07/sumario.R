...
# Função que calcula o desvio padrão, a variância e o maior e menor valor para a autocorrelação
# Parâmetros - (diretório dos arquivos, CPU[TRUE] ou Memória[FALSE], arquivo de saída)
# Exemplo de chamada: sumarioTOarquivo("C:/Users/Lari/Documents/GitHub/rua/US07/", TRUE, "sumario_cpu.csv")
# Exemplo de chamada: sumarioTOarquivo("C:/Users/Lari/Documents/GitHub/rua/US07/", FALSE, "sumario_mem.csv")
sumarioTOarquivo <- function(diretorio, cpu, arquivo){
  ...
  for(i in (1:40)){
    dados <- read.csv(paste(diretorio, "filesInput/xsys", i,".csv", sep=""))
